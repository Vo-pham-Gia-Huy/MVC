        ...
        <?php if($this->records) { ?>
			<?php while($row = mysqli_fetch_array($this->records)) : ?>
			  <tr>
				...
				<td width="12%"><?php echo $row['facebook']; ?></td>
				<td width="11%"><?php echo $row['created']; ?></td>
				<td width="15%"><img src="<?php echo "media/upload/" .$this->controller.'/'.$row['photo']; ?>" alt="<?php echo $row['email']; ?>" class="img-thumbnail"></td>
				<td width="15%">
